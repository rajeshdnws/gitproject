	...
	function ($, customer, quote, urlBuilder, urlFormatter, errorProcessor, messageContainer, __) {			
        ...
        return {
            ...
            validate: function () {
                ...
                var customer_shipping_comments = $('[name="customer_shipping_comments"]').val();
				var customer_shipping_date = $('[name="customer_shipping_date"]').val();
                var ophalen_winkel = $('[name="ophalen_winkel"]').val();

                var payload = {
                    cartId: quoteId,
                    orderComment: {
                        comment: comment,
						customer_shipping_comments:customer_shipping_comments,
						customer_shipping_date:customer_shipping_date,
						ophalen_winkel:ophalen_winkel
                    }
                };

                if (!payload.orderComment.ophalen_winkel) {
                    return true;
                }
