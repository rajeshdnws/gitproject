...
class OrderCommentManagement implements OrderCommentManagementInterface
{
    ...
    public function saveOrderComment(
        ...
        $customer_shipping_comments = $orderComment->getCustomerShippingComments();
		$customer_shipping_date = $orderComment->getCustomerShippingDate();
		$ophalen_winkel = $orderComment->getOphalenWinkel();

        $this->validateComment($comment);
        
        try {
             $quote->setData(OrderComment::COMMENT_FIELD_NAME, strip_tags($comment));
			 $quote->setData(OrderComment::COMMENT_FIELD_SHIP, strip_tags($customer_shipping_comments));
			 $quote->setData(OrderComment::COMMENT_FIELD_DATE, strip_tags($customer_shipping_date));
			 $quote->setData(OrderComment::COMMENT_FIELD_OP, strip_tags($ophalen_winkel));
