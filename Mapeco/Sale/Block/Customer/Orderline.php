...
class Orderline extends \Magento\Framework\View\Element\Template
{
	...
	public  function getErpOrderline()
	{
		$url='rest/orders';	
...
$creatie_firma=$this->customerSession->getCustomer()->getCreatieFirma();
 ...
 $orderFirma = "MPT"; 
	   ...
	   $parameterArray=array("firma_code"=>$orderFirma,"besteladresnummer"=>$fact,"muntcode"=>"EUR","page_number"=>10,"datum"=>"2023-1-1","header_detail"=>"D");
