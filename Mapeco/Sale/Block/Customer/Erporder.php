...
class Erporder extends \Magento\Framework\View\Element\Template
{
...
$creatie_firma=$this->customerSession->getCustomer()->getCreatieFirma();
 ...
 $orderFirma = "MPT"; 
		...
		$parameterArray=array("firma_code"=>$orderFirma,"besteladresnummer"=>$fact,"document_status"=>8,"muntcode"=>"EUR","page_number"=>1,"datum"=>"2023-1-1");
